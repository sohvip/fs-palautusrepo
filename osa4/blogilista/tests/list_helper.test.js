...
describe('author with most blogs', () => {
    ...
    const blogs = [
      ...
      test('when list has only one blog', () => {
        ...
        expect(listHelper.mostBlogs(listWithOneBlog)).toEqual(top)
      })
      ...
      test('when list has many blogs', () => {
        ...
        expect(listHelper.mostBlogs(blogs)).toEqual(top)
      })
...
describe('author with most likes', () => {
    ...
    const blogs = [
      ...
      test('when list has only one blog', () => {
        ...
        expect(listHelper.mostLikes(listWithOneBlog)).toEqual(top)
      })
      ...
      test('when list has many blogs', () => {
        ...
        expect(listHelper.mostLikes(blogs)).toEqual(top)
      })
